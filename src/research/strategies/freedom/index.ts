// ============================================================================
// KRIPTOQUANT — Freedom Multi-Timeframe Hybrid Strategy (Sprint 30)
// ============================================================================
// Strateji Kuralları:
...
export function createFreedomStrategy(): Strategy {
	return {
		name: 'freedom',
		description: 'Freedom Multi-Timeframe Strategy (4H Macro + 1H Structure + 15M trigger)',
					...
					if (hasPullback && isGreen && closedAboveEma && highVolume) {
						...
						if (risk > 0) {
							...
							signals.push({
								...
								reason: `FREEDOM BUY: 4H Trend Bullish, 1H Pullback confirmed, 15M Volume Breakout. SL: $${stopLossPrice.toFixed(2)} | TP: $${takeProfitPrice.toFixed(2)}`,
							});
